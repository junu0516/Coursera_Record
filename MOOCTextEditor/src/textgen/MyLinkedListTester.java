...
public class MyLinkedListTester {
	...
	public void testRemove()
	{
		...
		try {
			list1.remove(4); //greater than the size of the list
			fail("Invalid Index");
		}catch(IndexOutOfBoundsException e) {
		...
		assertEquals("Remove : check element 0 is correct","B",list1.get(0));
		assertEquals("Remove : check size is correct",2,list1.size());
	}
	...
	public void testAddAtIndex()
	{
		...
		shortList.add(0,"a");
		assertEquals("a added at index 0","a",shortList.get(0));
	}
	...
	public void testSet()
	{
		...
		String check = shortList.set(0, "D");
	    assertEquals("D set at index 0","D",shortList.get(0));
	}
